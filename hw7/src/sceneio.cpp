...
void loadFigures(size_t indicesIndex, const Transition &transition, size_t material, const std::vector<Vec3> &positions, const std::vector<Vec3> &normals, Scene &scene) {
